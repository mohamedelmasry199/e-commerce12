        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="index.html">
              <img class="brand-logo" alt="modern admin logo" src="<?php echo e(asset('assets/dashboard')); ?>/images/logo/logo.png">
              ...
              <ul class="mega-dropdown-menu dropdown-menu row">
                <li class="col-md-2">
                  ...
                  <div id="mega-menu-carousel-example">
                    <div>
                      <img class="rounded img-fluid mb-1" src="<?php echo e(asset('assets/dashboard')); ?>/images/slider/slider-2.png"
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                <span class="avatar avatar-online">
                  <img src="<?php echo e(asset('assets/dashboard')); ?>/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span>
              </a>
    ...
    <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown"
       aria-haspopup="true" aria-expanded="false">
        ...
        <i class="flag-icon
            ...
            <?php elseif(app()->getLocale() == 'fr'): ?> flag-icon-fr
            <?php elseif(app()->getLocale() == 'ar'): ?> flag-icon-eg
            <?php else: ?> flag-icon-<?php echo e(app()->getLocale()); ?>

            <?php endif; ?>">
        </i>
        <span class="selected-language">
            <?php echo e(LaravelLocalization::getSupportedLocales()[app()->getLocale()]['native']); ?>
            ...
            <a class="dropdown-item" rel="alternate" hreflang="<?php echo e($localeCode); ?>"
               href="<?php echo e(LaravelLocalization::getLocalizedURL($localeCode, null, [], true)); ?>">
                ...
                <i class="flag-icon
                    ...
                    <?php elseif($localeCode == 'fr'): ?> flag-icon-fr
                    <?php elseif($localeCode == 'ar'): ?> flag-icon-eg
                    <?php else: ?> flag-icon-<?php echo e($localeCode); ?>
                ...
                <li class="scrollable-container media-list w-100">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="<?php echo e(asset('assets/dashboard')); ?>/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                  ...
                  <a href="javascript:void(0)">
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="<?php echo e(asset('assets/dashboard')); ?>/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="<?php echo e(asset('assets/dashboard')); ?>/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
...
<?php /**PATH D:\my laravel projects\e-commerce paid\e-commerce12\resources\views/layouts/dashboard/_header.blade.php ENDPATH**/ ?>