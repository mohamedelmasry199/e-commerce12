<?php $__env->startSection('title', __('website.faq')); ?>
    ...
    <section class="blog about-blog">
        <div class="container">
            <div class="blog-bradcrum">
                ...
                <span><a href="javascript:void(0)" class="active"><?php echo e(__('website.faq')); ?></a></span>
            </div>
            <div class="blog-heading about-heading">
                <h1 class="heading"><?php echo e(__('website.faq')); ?></h1>
            </div>
        </div>
    </section>
            ...
            <div class="row gy-5">
                ...
                <div class="col-lg-6">
                    <div class="faq-accordion accordion accordion-flush" id="accordionFlushExample" data-aos="fade-right">
                        <h5><?php echo e(__('website.frequently_asked_questions')); ?></h5>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="faq-item accordion-item">
                        <h2 class="accordion-header">
                            <button class="faq-button accordion-button collapsed" type="button"
                                data-bs-toggle="collapse" data-bs-target="#flush-collapseOne_<?php echo e($item->id); ?>" aria-expanded="false"
                                aria-controls="flush-collapseOne_<?php echo e($item); ?>">
                        ...
                        <div id="flush-collapseOne_<?php echo e($item->id); ?>" class="accordion-collapse collapse"
                    ...
                    <div class="alert alert-info"><?php echo e(__('website.no_faq')); ?></div>
...
[$__name, $__params] = $__split('website.faq-question');

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2817578118-0', null);
...
<script>
    document.addEventListener('livewire:init', () => {
        ...
        Swal.fire({
                title: "<?php echo e(__('website.success')); ?>",
                text: event,
                icon: "success"
            });
       });
       Livewire.on('faq-question-failed', (event) => {
        Swal.fire({
                title: "<?php echo e(__('website.error')); ?>",
                text: event,
                icon: "error"
            });
       });
...
<?php echo $__env->make('layouts.website.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\my laravel projects\e-commerce paid\e-commerce12\resources\views/website/faq.blade.php ENDPATH**/ ?>