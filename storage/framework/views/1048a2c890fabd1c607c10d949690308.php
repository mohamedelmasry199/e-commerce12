    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('orders')): ?>
                <li class="nav-item"><a href="javascript:void(0)"><i class="la la-cart-arrow-down"></i><span
                            class="menu-title" data-i18n="nav.dash.main"><?php echo e(__('dashboard.orders')); ?></span><span
                            class="badge badge badge-info badge-pill float-right mr-2">10</span></a>
                    <ul class="menu-content">
                            <li><a class="menu-item" href="<?php echo e(route('dashboard.orders.index')); ?>"
                                    data-i18n="nav.dash.crypto"><?php echo e(__('dashboard.orders')); ?></a>
                            </li>
                    </ul>
                </li>
