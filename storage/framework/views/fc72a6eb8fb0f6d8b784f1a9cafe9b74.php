<?php $__env->startSection('title'); ?>
    <?php echo e(__('dashboard.faq_questions')); ?>
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard.faq.questions.index')); ?>">
                                        <?php echo e(__('dashboard.faq_questions')); ?></a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <table id="yajra_table" class="table table-striped table-bordered language-file">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo e(__('dashboard.reply')); ?></th>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        $('#yajra_table').DataTable({
            ...
            ajax: "<?php echo e(route('dashboard.faq.questions.all')); ?>",
            columns: [{
                    data: 'DT_RowIndex',
                    searchable: false,
                    orderable: false,
        ...
        $(document).on('click', '.delete_confirm_btn', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?php echo e(route('dashboard.faq.questions.destroy', 'id')); ?>".replace('id',
                            faq_question_id),
                        type: "DELETE",
                        data: {
    ...
    $.ajax({
        url: "<?php echo e(route('dashboard.faq.questions.reply', 'id')); ?>"
...
<?php echo $__env->make('layouts.dashboard.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\my laravel projects\e-commerce paid\e-commerce12\resources\views/dashboard/faq-questions/index.blade.php ENDPATH**/ ?>