            ...
            <div class="container">
                <div class="header-top">
                    <div class="header-profile">
                        <a href="<?php echo e(auth()->check() ? route('website.profile.show', auth()->id()) : 'login'); ?>"><span>Account</span></a>
                    ...
                    <div class="header-contact d-none d-lg-block">
                        <a href="#">
                            ...
                            <span class="contact-number"><?php echo e($setting->site_phone); ?></span>
                        </a>
                    </div>
                </div>
            </div>
...
[$__name, $__params] = $__split('website.wishlist.wishlist-icon');

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-812989125-0', null);
...
[$__name, $__params] = $__split('website.cart.cart-icon');

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-812989125-1', null);
...
?>
                        ...
                        <div class="header-user">
                            <a href="<?php echo e(auth()->check() ? route('website.profile.show', auth()->id()) : 'login'); ?>">
                                <span>
...
<?php /**PATH D:\my laravel projects\e-commerce paid\e-commerce12\resources\views/layouts/website/header.blade.php ENDPATH**/ ?>