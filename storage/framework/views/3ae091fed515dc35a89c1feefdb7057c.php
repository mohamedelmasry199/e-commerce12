<?php $__env->startSection('title', __('dashboard.edit_category')); ?>
...
<?php $__env->startSection('content'); ?>
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="">
                                        <?php echo e(__('dashboard.category_edit')); ?></a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-colored-form-control">
                                    <?php echo e(__('dashboard.category_edit')); ?>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                   ...
                                   <form class="form"
      action="<?php echo e(route('dashboard.categories.update', $category->id)); ?>"
      method="POST"
    ...
    <?php echo method_field('PUT'); ?>
                                        ...
                                        <input name="id" value="<?php echo e($category->id); ?>" type="hidden">

                                        <div class="form-body">
                                            <div class="form-group">
                                                <label for="eventRegInput1"><?php echo e(__('dashboard.name_en')); ?></label>
                                                <input type="text" value="<?php echo e($category->getTranslation('name', 'en')); ?>" class="form-control"
                                                    placeholder="<?php echo e(__('dashboard.name_en')); ?>" name="name[en]">
                                            </div>
                                            <div class="form-group">
                                                <label for="eventRegInput1"><?php echo e(__('dashboard.name_ar')); ?></label>
                                                <input type="text" value="<?php echo e($category->getTranslation('name', 'ar')); ?>" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="parent" class="form-control">
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($cat->id); ?>" <?php if($category->parent == $cat->id ): echo 'selected'; endif; ?>><?php echo e($cat->name); ?></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="d-inline-block custom-control custom-radio mr-1">
                                                        <input type="radio" value="1" <?php if($category->status == 1): echo 'checked'; endif; ?> name="status" class="custom-control-input"
                                                            id="yes1">
                                                        <label class="custom-control-label" for="yes1"><?php echo e(__('dashboard.active')); ?></label>
                                                    </div>
                                                    <div class="d-inline-block custom-control custom-radio">
                                                        <input type="radio" value="0" <?php if($category->status == 0 ): echo 'checked'; endif; ?> name="status" class="custom-control-input"
                                                            id="no1">
...
<script>
    ...
    $(function() {
         $('#single-image-edit').fileinput({
             ...
             initialPreview:[
                "<?php echo e(asset($category->icon)); ?>",
             ],
...
<?php echo $__env->make('layouts.dashboard.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\my laravel projects\e-commerce paid\e-commerce12\resources\views/dashboard/categories/edit.blade.php ENDPATH**/ ?>