<?php $__env->startSection('title', __('website.products')); ?>
<?php $__env->startSection('content'); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($products->count() > 0): ?>
        ...
        <section class="product product-sidebar   <?php if($flash_timer): ?>flash-sale <?php endif; ?> footer-padding">
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-12">
                        <div class="product-sidebar-section" data-aos="fade-up">
                            <div class="row g-5">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($flash_timer): ?>
                                <div class="col-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="product-sorting-section">
                                        <div class="result">
                                            <p><?php echo e(__('website.showing')); ?>

                                                <span><?php echo e($products->firstItem()); ?>–<?php echo e($products->lastItem()); ?>

                                                    <?php echo e(__('website.of')); ?> <?php echo e($products->total()); ?>

                                                    <?php echo e(__('website.results')); ?></span></p>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="product-description">
                                                    ...
                                                    <div class="price">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->has_variants == 0): ?>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->has_discount == 0): ?>
                                                                <span class="new-price"><?php echo e($item->price); ?> EGP</span>
                                                            <?php else: ?>
                                                                <span class="price-cut"><?php echo e($item->price); ?> EGP</span>
                                                                <span
                                                                    class="new-price"><?php echo e($item->getPriceAfterDiscount()); ?>
            ...
            <div class="container">
                <div class="blog-item" data-aos="fade-up">
                    ...
                    <div class="cart-content">
                        ...
                        <a href="product-sidebar.html" class="shop-btn"><?php echo e(__('website.back_to_shop')); ?></a>
                    </div>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('layouts.website.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\my laravel projects\e-commerce paid\e-commerce12\resources\views/website/products.blade.php ENDPATH**/ ?>