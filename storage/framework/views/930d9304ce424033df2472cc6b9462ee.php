    ...
    <section id="hero" class="hero">
        <div class="swiper hero-swiper">
            <div class="swiper-wrapper hero-wrapper">
                ...
                <div class="swiper-slide hero-slider-one" style="background:url(<?php echo e(asset($slider->file_name)); ?>) no-repeat center center; background-size: cover;">
                    <div class="container">
                        <div class="col-lg-6">
                            <div class="wrapper-section" data-aos="fade-up">
                                <div class="wrapper-info">
                                    ...
                                    <h1 class="wrapper-details"><?php echo e($slider->note); ?></h1>
  ...
  <section class="product-category">
    <div class="container">
        <div class="section-title">
            <h5><?php echo e(__('website.our_categories')); ?></h5>
            <a href="<?php echo e(route('website.categories.index')); ?>" class="view"><?php echo e(__('website.view_all')); ?></a>
        </div>
        <div class="category-section">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $someCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100"
                    style="display: flex; flex-direction: column; align-items: center; text-align: center; cursor: pointer;">

                    <a href="<?php echo e(route('website.categories.products', $item->slug)); ?>"
                        style="display: block; width: 100%; height: 120px; overflow: hidden; border-radius: 8px; flex-shrink: 0;">
                        <img src="<?php echo e(asset($item->icon)); ?>" alt="<?php echo e($item->name); ?>"
                            style="width: 100%; height: 100%; object-fit: cover; display: block;">
                    </a>

                    <div class="wrapper-info"
                        style="margin-top: 8px; width: 100%; padding: 0 4px;">
                        <a href="<?php echo e(route('website.categories.products', $item->slug)); ?>" class="wrapper-details"
                            style="display: block; font-size: 13px; font-weight: 500; color: #333; text-decoration: none; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
     ...
     <section class="product brand" data-aos="fade-up">
        <div class="container">
            <div class="section-title">
                <h5><?php echo e(__('website.brands_of_products')); ?></h5>
                <a href="<?php echo e(route('website.brands.index')); ?>" class="view"><?php echo e(__('website.view_all')); ?></a>
            </div>
            <div class="brand-section">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $someBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="<?php echo e(route('website.brands.products',$item->slug)); ?>">
                            <img src="<?php echo e(asset($item->logo)); ?>" alt="<?php echo e($item->name); ?>">
                        </a>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($homePageProducts['newArriavals']->count()>0): ?>
    <section class="product arrival">
        <div class="container">
            <div class="section-title">
                <h5><?php echo e(__('website.new_arrivals')); ?> </h5>
                <a href="<?php echo e(route('website.products.by.type','new-arrivals')); ?>" class="view"><?php echo e(__('website.view_all')); ?></a>
            </div>
            <div class="arrival-section">
                <div class="row g-5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $homePageProducts['newArriavals']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="<?php echo e($item->getFirstImage()); ?>" alt="product-img">
                                <div
                                ...
                                <div class="product-cart-items">
                                    <a href="<?php echo e(route('website.products.show', $item->slug)); ?>" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="<?php echo e(route('website.products.show', $item->slug)); ?>" class="product-details"><?php echo e($item->name); ?>

                                    </a>
                                    <div class="price">
                                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->has_variants): ?>
                                      ...
                                      <?php else: ?>
                                        ...
                                        <span class="new-price"><?php echo e($item->getPriceAfterDiscount()); ?> EGP</span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </div>
                            ...
                            <div class="product-cart-btn">
                                <a href="<?php echo e(route('website.categories.products',$item->category->slug)); ?>" class="product-btn"><?php echo e($item->category->name); ?></a>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($homePageProducts['flashProductsTimer']->count()>0): ?>
            ...
            <div class="section-title">
                ...
                <div class="countdown-section">
                    <div class="countdown-items">
                        <span id="day" class="number" style="color: red;">1</span>
                        <span class="text">Days</span>
                    </div>
                    <div class="countdown-items">
                        <span id="hour" class="number" style="color: skyblue;">2</span>
                        <span class="text">Hours</span>
                    </div>
                    <div class="countdown-items">
                        <span id="minute" class="number" style="color: green;">2</span>
                        <span class="text">Minutes</span>
                    </div>
                    <div class="countdown-items">
                        <span id="second" class="number" style="color: red;">55</span>
                        <span class="text">seconds</span>
                    </div>
                </div>
                <a href="<?php echo e(route('website.products.by.type','flash-timers')); ?>" class="view"><?php echo e(__('website.view_all')); ?></a>
            </div>
            <div class="flash-sale-section">
                <div class="row g-5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $homePageProducts['flashProductsTimer']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                            <div class="product-img">
                                <img src="<?php echo e($item->getFirstImage()); ?>" alt="<?php echo e($item->name); ?>">
                                <div
                                class="position-absolute top-0 start-0 bg-danger text-white py-1 px-2 m-2 rounded">
                                <?php echo e($item->brand->name); ?>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->has_variants == 0): ?>
                                        <span class="price-cut"><?php echo e($item->firstVariant()->price); ?></span>
                                        <span class="new-price"><?php echo e($item->getPriceAfterDiscount()); ?></span>
                                    <?php else: ?>
                                        <span class="new-price"><?php echo e(__('website.has_variants')); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($homePageProducts['flashProducts']->count()>0): ?>
    <section class="product best-product">
        <div class="container">
            <div class="section-title">
                <h5><?php echo e(__('website.flash_sale')); ?></h5>
                <a href="<?php echo e(route('website.products.by.type','flash-products')); ?>" class="view"><?php echo e(__('website.view_all')); ?></a>
            </div>
            <div class="best-product-section">
                <div class="row g-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $homePageProducts['flashProducts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
    <script src="<?php echo e(asset('assets/website/assets/js/flash-timer-products.js')); ?>"></script>

<?php echo $__env->make('layouts.website.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\my laravel projects\e-commerce paid\e-commerce12\resources\views/website/index.blade.php ENDPATH**/ ?>