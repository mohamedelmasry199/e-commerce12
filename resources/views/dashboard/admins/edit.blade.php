                        ...
                        <div class="card shadow-lg rounded">
                            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                                <h4 class="card-title mb-0">
                                    <i class="la la-user-edit"></i> {{ __('dashboard.update_admin') }}
                                </h4>
                                                    ...
                                                    <select class="form-control" name="role_id" id="role_id">
                                                        <optgroup label="{{ __('dashboard.select_role') }}">
                                                            @foreach ($roles as $role)
                                                                <option @selected($role->id == $admin->role_id) value="{{ $role->id }}">
                                                                    {{ $role->role }}
                                                                </option>
                                                            @endforeach
                                                        </optgroup>
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    ...
                                                    <select class="form-control" name="status" id="status">
                                                        <optgroup label="{{ __('dashboard.select_status') }}">
                                                            <option @selected($admin->status == 'Active') value="1">
                                                                {{ __('dashboard.active') }}
                                                            </option>
                                                            <option @selected($admin->status == 'Inactive') value="0">
