                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{ route('dashboard.pages.update',$page->id)}}" method="POST" enctype="multipart/form-data" >
                                        @csrf
                                        @method('PUT')
                                         <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernote" type="text" class="form-control" name="content[ar]">{!! $page->getTranslation('content','ar')!!}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="eventRegInput1">{{ __('dashboard.content_en') }}</label>
                                                <textarea id="summernote2" type="text" class="form-control" name="content[en]">{!! $page->getTranslation('content','en')!!}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="is_active" class="form-control" id="is_active">
                                                    <option value="1" {{ old('is_active',$page->is_active) == 1 ? 'selected' : '' }}>{{ __('dashboard.active') }}</option>
                                                    <option value="0" {{ old('is_active',$page->is_active) == 0 ? 'selected' : '' }}>{{ __('dashboard.inactive') }}</option>
                                                </select>
                                                </div>
                                            <div class="form-group">
                                                <label for="eventRegInput1">{{ __('dashboard.meta_title_ar') }}</label>
                                                <input type="text" value="{{ old('meta_title[ar]',$page->getTranslation('meta_title','ar'))}}" class="form-control"
                                                    placeholder="{{ __('dashboard.meta_title_ar') }}" name="meta_title[ar]">
                                                    </div>
                                            <div class="form-group">
                                                <label for="eventRegInput1">{{ __('dashboard.meta_title_en') }}</label>
                                                <input type="text" value="{{ old('meta_title[en]',$page->getTranslation('meta_title','en'))}}" class="form-control"
                                                    placeholder="{{ __('dashboard.meta_title_en') }}" name="meta_title[en]">
                                                    </div>
                                            <div class="form-group">
                                                <label for="eventRegInput1">{{ __('dashboard.meta_description_ar') }}</label>
                                                <input type="text" value="{{ old('meta_description[ar]',$page->getTranslation('meta_description','ar'))}}" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('meta_description[en]',$page->getTranslation('meta_description','en'))}}" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('meta_keywords[ar]',$page->getTranslation('meta_keywords','ar'))}}" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('meta_keywords[en]',$page->getTranslation('meta_keywords','en'))}}" class="form-control"
