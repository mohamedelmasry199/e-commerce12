<div class="form-group">
    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
      <a href="{{ route('dashboard.coupons.edit', $coupon->id)}}" type="button" class="btn  btn-outline-success" > {{ __('dashboard.edit') }} <i class="la la-edit"></i></a>
      <a href="{{ route('dashboard.coupons.edit' , $coupon->id) }}" type="button" class="btn btn-outline-info">{{ __('dashboard.status_management') }} <i class="la la-stop"></i> </a>
