...
@section('content')
    ...
    <section id="hero" class="hero">
        <div class="swiper hero-swiper">
            <div class="swiper-wrapper hero-wrapper">
                ...
                <div class="swiper-slide hero-slider-one" style="background:url({{ asset($slider->file_name) }}) no-repeat center center; background-size: cover;">
                    <div class="container">
                        <div class="col-lg-6">
  ...
  <section class="product-category">
            ...
            @forelse ($someCategories as $item)
                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100"
                    ...
                    <div class="wrapper-info"
                        ...
                        <a href="{{ route('website.categories.products', $item->slug) }}" class="wrapper-details"
    ...
    @if($homePageProducts['newArriavals']->count()>0)
    <section class="product arrival">
        <div class="container">
            ...
            <div class="arrival-section">
                <div class="row g-5">
                    @forelse($homePageProducts['newArriavals'] as $item)
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{$item->getFirstImage() }}" alt="product-img">
                                <div
                                ...
                                <div class="product-cart-items">
                                    <a href="{{ route('website.products.show', $item->slug) }}" class="cart cart-item">
                                        <span>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    <a href="{{ route('website.products.show', $item->slug) }}" class="product-details">{{ $item->name }}
                                    </a>
                                    <div class="price">
                                      @if($item->has_variants)
                                        <span class="new-price">{{__('website.has_variants')}}</span>
                                      @else
                                        @if($item->firstVariant()->has_discount == 0)
                                        <span class="new-price">{{ $item->firstVariant()->price }} EGP</span>
                                        @else
                                        <span class="price-cut">{{ $item->firstVariant()->price }} EGP</span>
                            ...
                            <div class="product-cart-btn">
                                <a href="{{route('website.categories.products',$item->category->slug)}}" class="product-btn">{{ $item->category->name }}</a>
                            </div>
                        </div>
                    </div>
                    @empty
    ...
    {{-- Products Flash Timer Section --}}
    @if($homePageProducts['flashProductsTimer']->count()>0)
    <section class="product flash-sale">
        <div class="container">
            <div class="section-title">
                ...
                <a href="{{route('website.products.by.type','flash-timers')}}" class="view">{{ __('website.view_all') }}</a>
            </div>
            <div class="flash-sale-section">
                <div class="row g-5">
                    @foreach ($homePageProducts['flashProductsTimer'] as $item)
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                            <div class="product-img">
                                <img src="{{$item->getFirstImage() }}" alt="{{ $item->name }}">
                                <div
                                class="position-absolute top-0 start-0 bg-danger text-white py-1 px-2 m-2 rounded">
                                {{ $item->brand->name }}
                                </div>
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-description">
                                    ...
                                    @if($item->has_variants == 0)
                                        <span class="price-cut">{{ $item->firstVariant()->price }}</span>
    ...
    <section class="product best-product">
        <div class="container">
            <div class="section-title">
                ...
                <a href="{{route('website.products.by.type','flash-products')}}" class="view">{{ __('website.view_all') }}</a>
            </div>
            <div class="best-product-section">
                <div class="row g-4">
                    @foreach ($homePageProducts['flashProducts'] as $item )
...
@endsection
    <script src="{{ asset('assets/website/assets/js/flash-timer-products.js') }}"></script>
