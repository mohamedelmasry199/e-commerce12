            ...
            <div class="swiper-wrapper">
                @foreach ($product->images as $item)
                    <div class="swiper-slide slider-top-img">
                        <img src="{{ asset('uploads/products/' . $item->file_name) }}"
                            alt="{{ $product->name }}">
                    </div>
                @endforeach
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="product-info-content">
                            ...
                            <div class="ratings">
                                ...
                                <span class="text">{{ $product->productReviews->count() }}
                                    {{ __('website.reviews') }}</span>
                            </div>
            ...
            <div class="product-detail-section">
                ...
                <div class="tab-content tab-item" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab"
                        tabindex="0">
                        @livewire('website.product-preview', ['product' => $product])
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="product weekly-sale product-weekly footer-padding">
        <div class="container">
            <div class="section-title">
                <h5>{{ __('website.related_products') }}</h5>
                            ...
                            <div class="product-wrapper">
                                <div class="product-img">
                                    ...
                                    <div class="product-cart-items">
                                        <a href="{{ route('website.products.show', $item->slug) }}"
                                        ...
                                        <div class="price">
                                            @if ($item->has_variants == 0)
                                                ...
                                                @else
                                                    ...
                                                    <span class="new-price">{{ $item->getPriceAfterDiscount() }}
                                                        EGP</span>
                                                @endif
                                            @else
                                ...
                                <div class="product-cart-btn">
                                    <a href="{{ route('website.categories.products', $item->category->slug) }}"
