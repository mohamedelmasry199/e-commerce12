    ...
    <section class="blog about-blog">
        <div class="container">
            <div class="blog-bradcrum">
                ...
                <span><a href="javascript:void(0)" class="active">{{ __('website.faq') }}</a></span>
            </div>
            <div class="blog-heading about-heading">
                <h1 class="heading">{{ __('website.faq') }}</h1>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row gy-5">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="faq-item accordion-item">
                        <h2 class="accordion-header">
                            <button class="faq-button accordion-button collapsed" type="button"
                                data-bs-toggle="collapse" data-bs-target="#flush-collapseOne_{{ $item->id }}" aria-expanded="false"
                                aria-controls="flush-collapseOne_{{ $item }}">
                    ...
                    @empty
                    <div class="alert alert-info">{{ __('website.no_faq') }}</div>
                    @endforelse
                    </div>
                </div>
