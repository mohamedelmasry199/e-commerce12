            ...
            <div class="container">
                <div class="header-top">
                    <div class="header-profile">
                        <a href="{{ auth()->check() ? route('website.profile.show', auth()->id()) : 'login' }}"><span>Account</span></a>
                    ...
                    <div class="header-contact d-none d-lg-block">
                        <a href="#">
                            ...
                            <span class="contact-number">{{ $setting->site_phone }}</span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="header-center">
                    ...
                    <div class="header-cart-items">
                        ...
                        <div class="header-user">
                            <a href="{{ auth()->check() ? route('website.profile.show', auth()->id()) : 'login' }}">
                                <span>
                            ...
                            <li>
                                ...
                                <ul class="header-sub-menu">
                                    ...
                                    @foreach ($pages as $page)
                                        <li><a href="{{ route('website.page.show', $page->slug) }}">{{ $page->title }}</a></li>
                                    @endforeach
                                    @endif
